...
export default function Welcome({ auth, phpVersion }) {
    ...
    return (
        <>
            ...
            <main
                className="antialiased bg-gradient-to-br from-transparent via-white to-green-100 dark:from-[#102e36] dark:via-[#001318] dark:to-[#001318] dark:text-white/50">
                <div className="text-black/50 dark:text-white/50 flex flex-col justify-between items-center min-h-screen">
                        ...
                        <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <a href="https://leafphp.dev/docs/" id="docs-card"
                                ...
                                <div id="screenshot-container" className="relative flex w-full flex-1 items-stretch">
                                    ...
                                    <div
                                        className="absolute -bottom-16 -left-16 h-40 w-[calc(100%_+_8rem)] bg-gradient-to-br from-transparent via-white to-white dark:from-[#001e26] dark:via-[#001318] dark:to-[#001e26] blur-xl">
                                    </div>
                                </div>
                                ...
                                <div className="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
                                        <div
                                            className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#3eaf7c]/10 sm:size-16">
                                            <svg className="size-5 sm:size-6 text-[#3eaf7c]" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <svg className="size-6 shrink-0 stroke-[#3eaf7c]" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <div
                                ...
                                <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#647eff]/10">
                                    <svg className="size-5 sm:size-6 text-[#647eff]" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <div className="pt-3">
                                    <h2 className="text-xl font-semibold text-black dark:text-white">Let's build your next big app</h2>
                                    ...
                                    <p className="text-xs/relaxed rounded-xl border border-[rgba(172,175,176,0.3)] py-2 px-4 mt-4">
                                        Get started by
                                        editing<code className="text-[#5e79c7]"> app/views/index.blade.php</code>
                                    </p>
                                </div>
                            </div>
                            ...
                            <a href="https://bento.me/leafphp"
                                ...
                                <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-red-500/10">
                                    <svg className="size-5 sm:size-6 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                        stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round"
                                ...
                                <div className="pt-3">
                                    <h2 className="text-xl font-semibold text-black dark:text-white">Connect with us</h2>
                                ...
                                <svg className="size-6 shrink-0 self-center stroke-red-500" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="https://leafphp.dev/docs/modules/"
                                ...
                                <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-yellow-400/10">
                                    <svg className="size-5 sm:size-6 text-yellow-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round"
                                ...
                                <div className="pt-3">
                                    <h2 className="text-xl font-semibold text-black dark:text-white">30+ Modules</h2>
                                ...
                                <svg className="size-6 shrink-0 self-center stroke-yellow-400" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24" strokeWidth="1.5">
                                    <path strokeLinecap="round" strokeLinejoin="round"
                                        d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
                                </svg>
                    ...
                    <footer
                        className="relative bg-transparent dark:bg-[#001318] w-full h-[70px] flex items-center border-t border-gray-700/10 dark:border-[#001e26]">
                        <div className="absolute inset-x-0 flex items-center justify-center -top-3 px-2">
                            <a href="https://leafphp.dev" target="_blank" className="px-4">
                                <img src="https://leafphp.dev/logo-circle.png" className="size-8 -mt-1" alt="" />
                            </a>
                        </div>
                        <div className="mx-auto sm:px-6 lg:px-8 px-4 w-full">
                            <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
                                <div className="flex flex-col-reverse items-center gap-3 sm:flex-row"><span
                                        className="text-sm text-gray-700 dark:text-gray-300">Leaf MVC v4.x-Beta - PHP
                                        v{phpVersion}</span>
                                </div>
                                <ul className="flex items-center justify-end gap-3">
                                    <li>
                                        <a href="https://discord.gg/Pkrm9NJPE3" target="_blank"
                                            className="focus-visible:ring-2 text-gray-700 hover:text-black dark:text-gray-300 dark:hover:text-white"><span
                                                className="sr-only">Leaf Discord Server</span>
                                    ...
                                    <li>
                                        <a href="https://x.com/leafphp" target="_blank"
                                            className="focus-visible:ring-2 text-gray-700 hover:text-black dark:text-gray-300 dark:hover:text-white"><span
                                                className="sr-only">Leaf Twitter</span>
                                    ...
                                    <li>
                                        <a href="https://github.com/leafsphp/leaf" target="_blank"
                                            className="focus-visible:ring-2 text-gray-700 hover:text-black dark:text-gray-300 dark:hover:text-white"><span
                                                className="sr-only">Leaf GitHub Repository</span>
