...
>
    ...
    >
        ...
        <div
            class="flex justify-center items-center w-full text-zinc-400 uppercase text-xs my-6"
        >
        ...
        <div class="relative space-y-2 w-full">
            <Button
                as={Link}
                href="/auth/google"
                class="py-3 space-x-2.5 gap-0 w-full h-auto text-sm justify-start border border-zinc-200 text-zinc-600 hover:bg-zinc-100 bg-white"
            >
                <span class="w-5 h-5">
                    <svg
                        class="w-full h-full"
