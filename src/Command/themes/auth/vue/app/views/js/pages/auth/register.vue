    ...
    <div
        ...
        <div
            ...
            <div className="flex flex-col sm:mx-auto sm:w-full mb-5 sm:max-w-md items-center text-black">
                <Link href="/">
                <img src="https://leafphp.dev/logo-circle.png" alt="Leaf MVC" className="size-10" />
                </Link>
            ...
            <div class="relative space-y-2 w-full">
                <Button :as="Link" href="/auth/google"
                    class="flex py-3 space-x-2.5 gap-0 w-full h-auto text-sm justify-start border border-zinc-200 text-zinc-600 hover:bg-zinc-100 bg-white">
                ...
                <Button :as="Link" href="/auth/github"
                    class="flex py-3 space-x-2.5 gap-0 w-full h-auto text-sm justify-start border border-zinc-200 text-zinc-600 hover:bg-zinc-100 bg-white">
                    <span class="w-5 h-5 inline-flex">
                        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
