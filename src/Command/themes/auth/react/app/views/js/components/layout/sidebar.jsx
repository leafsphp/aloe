...
// This contains utils for creating a sidebar layout.
// View ./header.jsx for the actual navigation component

import Button from "@/components/form/button";
import Input from "@/components/form/input";
import { Separator } from "@/components/shared/separator";
import { Sheet, SheetContent, SheetTitle } from "@/components/layout/sheet";
...
const SidebarMenuAction = React.forwardRef(
    ({ className, as = "button", showOnHover = false, ...props }, ref) => {
        const Comp = as ?? "button";
...
const SidebarMenuSubButton = React.forwardRef(
    ({ as = "a", size = "md", isActive, className, ...props }, ref) => {
        const Comp = as ?? "a";
