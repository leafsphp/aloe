...
const Lander = ({ auth, stat1 = 0, stat2 = 0 }) => {
    return (
        < >
            ...
            <section className="relative pt-60" data-zero-component="Hero">
            ...
            <section className="bg-black text-white py-16 mt-32" data-zero-component="Features">
                <div class="container mx-auto px-2 sm:px-0">
                    ...
                    <div className="grid lg:grid-cols-3 gap-4">
                        <div className="bg-accent p-4 md:p-10 rounded-2xl overflow-hidden col-span-3 aspect-video flex items-end justify-start">
                        ...
                        <div className="bg-accent p-4 md:p-10 rounded-2xl overflow-hidden aspect-video flex items-end justify-start">
                            <div className="max-w-sm">
                        ...
                        <div className="bg-accent p-4 md:p-10 rounded-2xl overflow-hidden aspect-video flex items-end justify-start">
                            <div className="max-w-sm">
                                <h3 className="text-xl">Some Title</h3>
                                <p>
            ...
            <section data-zero-component="Stats">
                <div className="w-full py-32">
                    ...
                    <div className="flex flex-col items-center gap-16 w-full text-center">
                        ...
                        <div className="font-medium text-[96px] text-chart-2 leading-none">
            ...
            <section className="flex justify-center items-center bg-accent dark:bg-accent/80 py-32" data-zero-component="DataAction">
                        ...
                        <div className="col-span-4 sm:col-span-2 sm:order-2 md:col-span-7 lg:col-span-6 lg:pl-lg">
                            <div className="mb-2xl" role="list">
                                <p
                                    ...
                                    tabIndex="0"
                                >
                                    <span className="block text-body-lg text-chart-2 w-10 md:w-16">
                                        01
                                    </span>
                                    <span className="block grow border-b dark:border-b-chart-2 pb-2 md:py-3 transition-color duration-300 text-pretty text-white">
                                        Do this and that
                                    </span>
                                </p>
                                <p
                                ...
                                >
                                    ...
                                    <span className="block grow border-b dark:border-b-chart-2 pb-2 md:py-3 transition-color duration-300 text-pretty border-transparent text-white">
                                        Do this and that
                                    </span>
                                </p>
                            </div>
            ...
            <footer className="bg-[size:1540px] bg-left-top bg-no-repeat px-6 text-default" data-zero-component="Footer">
