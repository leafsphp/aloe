...
import { CheckCircle, MailCheckIcon } from 'lucide-vue-next';
...
<template>
    ...
    <Head title="Do this and that easily" />
    ...
    <section class="relative pt-60" data-zero-component="Hero">
        <div class="max-w-screen-xl mx-auto px-2 sm:px-4 text-center">
            ...
            <p class="max-w-[667px] mx-auto text-xl text-gray-500 dark:text-gray-300">
                Do you always struggle with this and that? Do you want to
                do this and that? Then my-app is the right place for you.
                Do this and that effortlessly, without any hassle.
            </p>

            <Button :as="Link" href="/dashboard" class="my-10" v-if="auth.user">
                Back to Dashboard
            </Button>
            <form v-else
                ...
                <div class="flex items-center h-full flex-1 px-3 gap-3">
                    <label htmlFor="email" class="h-6 w-6 grid place-content-center">
    ...
    <section class="bg-black text-white py-16 mt-32" data-zero-component="Features">
        <div class="container mx-auto px-2 sm:px-0">
            <div class="flex flex-wrap sm:flex-nowrap sm:items-center mb-10">
                ...
                <div class="w-full sm:w-1/3 lg:w-2/5">
                    <p class="richtext text-body-sm text-gray-c text-pretty inline-block">
                        Do this and that, but do it super fast and easy using all the tools my-app has
                        for you. No need for prior experience, just do it
                    </p>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-4">
                <div
                    ...
                    <div class="max-w-sm">
                        No complex setup, no skills required. Whether
                        you're a skilled doer or a beginner, my-app is
                        just the place to do this and that. Get started
                        in minutes and start doing.
                    </div>
                </div>
                <div
                    ...
                    <div class="max-w-sm">
                        ...
                        <p>
                            Get a free place to do this and that with
                            your personalized journey on my-app. Try
                            it out for free and see how it works for you.
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div class="max-w-sm">
                        ...
                        <p>
                            Get insights into your how much you do this
                            and that, track your performance, and make
                            changes to do even better.
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div class="max-w-sm">
                        ...
                        <p>
                            Do this and that will a smile on your face
                            and a sense of accomplishment. Get started
            ...
            <div class="flex flex-col items-center gap-16 w-full text-center">
                <div>
                    ...
                    <p class="mt-4 text-lg text-muted-foreground">
                        Do this and that, with a little bit more of this
                        and that, and do it fast. Break the limits and
                        do more with my-app.
                    </p>
                </div>
