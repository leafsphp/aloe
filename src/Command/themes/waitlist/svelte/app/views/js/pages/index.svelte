<script>
    ...
    import WaitlistForm from "@/components/waitlist/form.svelte";
...
>
    ...
    <div class="relative z-10 max-w-6xl w-full mx-auto text-center pt-32 pb-24">
        ...
        <div class="space-y-8 mb-16 max-w-5xl mx-auto text-center">
            ...
            <p
                class="text-lg md:text-xl text-primary/70 max-w-2xl mx-auto leading-relaxed"
            >
                Say goodbye to doing this & that with greedy expenses, My App is
                here to help you save money and time, while making your life
                easier.
            </p>
        </div>
        ...
        <div class="mt-16 mb-12">
            ...
            >
                <div
                    class="w-full px-4 py-3 border-b border-white/10 flex items-center gap-2"
                >
                ...
                <div class="p-1">
                    <div
                        class="w-full aspect-video rounded-lg overflow-hidden gradient-border bg-black/20"
                    >
                        <div
                            class="w-full h-full flex items-center justify-center text-white/20 text-sm"
                        >
                            Preview coming soon
                        </div>
                    </div>
